...
final class Logger {
    ...
    /// debug: Adds a debug message to the Datasenses log
    ...
    /// info: Adds an informational message to the Datasenses log
    /// - Parameter message: The message to be added to the log
    ...
    /// warn: Adds a warning message to the Datasenses log
    /// - Parameter message: The message to be added to the log
    ...
    /// error: Adds an error message to the Datasenses log
    /// - Parameter message: The message to be added to the log
